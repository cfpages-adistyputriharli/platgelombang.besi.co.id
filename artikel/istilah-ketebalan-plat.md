---
article_id: PGL-06-03
title: "Nominal, Aktual, Base Metal, dan Finished Thickness"
slug: "istilah-ketebalan-plat"
description: "Explain different thickness bases, coating effects, sampling, tolerances, and clarification questions"
status: outline
publication_date: "2025-11-19"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PGL-06
primary_intent: "Resolve thickness ambiguity"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/istilah-ketebalan-plat.html"
...
# Nominal, Aktual, Base Metal, dan Finished Thickness

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Nominal, Aktual, Base Metal, dan Finished Thickness”
- **Reader and situation:** Buyer comparing quotations
- **Reader outcome:** Explain different thickness bases, coating effects, sampling, tolerances, and clarification questions
- **Primary intent:** Resolve thickness ambiguity
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not certify a supplied batch; PGL-13-04 owns receiving disposition
- **Final public route:** `/artikel/istilah-ketebalan-plat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Nominal, Aktual, Base Metal, dan Finished Thickness**.
...
- **Tie back to this article:** Keep the explanation specific to “Nominal, Aktual, Base Metal, dan Finished Thickness”.
