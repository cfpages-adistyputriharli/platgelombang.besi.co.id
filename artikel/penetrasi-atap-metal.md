---
article_id: PGL-10-04
title: "Penetrasi Pipa, Vent, Skylight, dan Peralatan di Atap Metal"
slug: "penetrasi-atap-metal"
description: "Cover curbs, drainage side, flashing, movement, support, service access, and future replacement"
status: outline
publication_date: "2026-02-24"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PGL-10
primary_intent: "Coordinate penetrations"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/penetrasi-atap-metal.html"
...
# Penetrasi Pipa, Vent, Skylight, dan Peralatan di Atap Metal

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Penetrasi Pipa, Vent, Skylight, dan Peralatan di Atap Metal”
- **Reader and situation:** MEP/roof team
- **Reader outcome:** Cover curbs, drainage side, flashing, movement, support, service access, and future replacement
- **Primary intent:** Coordinate penetrations
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not approve structural openings; PGL-09-01 and engineer own support
- **Final public route:** `/artikel/penetrasi-atap-metal.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Penetrasi Pipa, Vent, Skylight, dan Peralatan di Atap Metal**.
...
- **TOPIC-GATE:** G-05, G-09, G-19, G-23, G-24, G-25
...
- `PGL-10-02` → `/artikel/detail-valley-talang-internal.html` — Valley dan Talang Internal: Titik Risiko Tinggi
- `PGL-10-03` → `/artikel/flashing-atap-ke-dinding.html` — Flashing Sambungan Atap ke Dinding dan Parapet
- `PGL-10-05` → `/artikel/kompatibilitas-talang-atap-metal.html` — Talang, Downpipe, dan Kontak Logam yang Kompatibel
- `PGL-10-06` → `/artikel/closure-sealant-atap-gelombang.html` — Closure dan Sealant pada Profil Gelombang
...
- **Tie back to this article:** Keep the explanation specific to “Penetrasi Pipa, Vent, Skylight, dan Peralatan di Atap Metal”.
