---
article_id: PGL-07-05
title: "Thermal Bridge pada Purlin, Fastener, dan Sambungan Atap"
slug: "thermal-bridge-atap-metal"
description: "Explain conductive paths, insulation discontinuity, compression, fasteners, junctions, and condensation risk"
status: outline
publication_date: "2025-12-17"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PGL-07
primary_intent: "Identify heat/moisture bridges"
...
# Thermal Bridge pada Purlin, Fastener, dan Sambungan Atap

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Thermal Bridge pada Purlin, Fastener, dan Sambungan Atap”
- **Reader and situation:** Designer
- **Reader outcome:** Explain conductive paths, insulation discontinuity, compression, fasteners, junctions, and condensation risk
- **Primary intent:** Identify heat/moisture bridges
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not calculate energy performance; qualified analysis owns values
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Thermal Bridge pada Purlin, Fastener, dan Sambungan Atap**.
...
- **Tie back to this article:** Keep the explanation specific to “Thermal Bridge pada Purlin, Fastener, dan Sambungan Atap”.
