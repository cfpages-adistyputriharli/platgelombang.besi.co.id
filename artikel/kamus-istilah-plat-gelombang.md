---
article_id: PGL-01-03
title: "Sheet, Coil, Corrugated, Profiled, dan Deck: Kamus Istilah"
slug: "kamus-istilah-plat-gelombang"
description: "Map common English/Indonesian terms and flag ambiguous seller language"
status: outline
publication_date: "2025-07-22"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PGL-01
primary_intent: "Translate trade terms"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/kamus-istilah-plat-gelombang.html"
...
# Sheet, Coil, Corrugated, Profiled, dan Deck: Kamus Istilah

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Sheet, Coil, Corrugated, Profiled, dan Deck: Kamus Istilah”
- **Reader and situation:** Procurement reconciling labels
- **Reader outcome:** Map common English/Indonesian terms and flag ambiguous seller language
- **Primary intent:** Translate trade terms
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not certify equivalence; PGL-13-02 owns evidence checks
- **Final public route:** `/artikel/kamus-istilah-plat-gelombang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sheet, Coil, Corrugated, Profiled, dan Deck: Kamus Istilah**.
...
- `PGL-01-01` → `/artikel/apa-itu-plat-gelombang.html` — Apa Itu Plat Gelombang? Bentuk, Fungsi, dan Sistemnya
...
- **Tie back to this article:** Keep the explanation specific to “Sheet, Coil, Corrugated, Profiled, dan Deck: Kamus Istilah”.
