---
article_id: PGL-02-06
title: "Korosi Galvanik pada Plat, Screw, Flashing, dan Talang"
slug: "korosi-galvanik-sistem-atap"
description: "Explain metal contact, electrolyte, area effects, isolation, drainage, and verification"
status: outline
publication_date: "2025-08-24"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PGL-02
primary_intent: "Prevent incompatible interfaces"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/korosi-galvanik-sistem-atap.html"
...
# Korosi Galvanik pada Plat, Screw, Flashing, dan Talang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Korosi Galvanik pada Plat, Screw, Flashing, dan Talang”
- **Reader and situation:** Designer detailing mixed metals
- **Reader outcome:** Explain metal contact, electrolyte, area effects, isolation, drainage, and verification
- **Primary intent:** Prevent incompatible interfaces
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not size fixings; PGL-09-04 owns structural coordination
- **Final public route:** `/artikel/korosi-galvanik-sistem-atap.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Korosi Galvanik pada Plat, Screw, Flashing, dan Talang**.
...
- `PGL-02-05` → `/artikel/menilai-klaim-anti-karat-atap.html` — Cara Menilai Klaim Anti Karat dan Umur Pakai Atap Metal
...
- **Tie back to this article:** Keep the explanation specific to “Korosi Galvanik pada Plat, Screw, Flashing, dan Talang”.
