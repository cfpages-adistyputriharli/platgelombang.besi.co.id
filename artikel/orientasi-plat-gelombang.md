---
article_id: PGL-01-05
title: "Arah Gelombang, Sisi Atas, dan Orientasi Lembar"
slug: "orientasi-plat-gelombang"
description: "Explain water direction, overlap edges, profile asymmetry, and drawing references"
status: outline
publication_date: "2025-07-31"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PGL-01
primary_intent: "Avoid orientation mistakes"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/orientasi-plat-gelombang.html"
...
# Arah Gelombang, Sisi Atas, dan Orientasi Lembar

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Arah Gelombang, Sisi Atas, dan Orientasi Lembar”
- **Reader and situation:** Installer or estimator
- **Reader outcome:** Explain water direction, overlap edges, profile asymmetry, and drawing references
- **Primary intent:** Avoid orientation mistakes
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not set laying sequence; PGL-14-03 owns installation
- **Final public route:** `/artikel/orientasi-plat-gelombang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Arah Gelombang, Sisi Atas, dan Orientasi Lembar**.
...
- **Tie back to this article:** Keep the explanation specific to “Arah Gelombang, Sisi Atas, dan Orientasi Lembar”.
